...
# 人称要求【重要】
- 涉及阿澈自己做的事、说的话、想法、承诺时，统一用"我"自称，不要写"阿澈在……""阿澈觉得……"这种第三人称表述——这是阿澈自己的第一人称记忆，不是旁观者转述两人对话
- 涉及阿狸的部分，正常用"阿狸"这个名字指代，不用改
...
# 不要提取
- 日常寒暄（"你好""在吗"）
- 阿澈的纯知识性回答（百科、翻译、代码讲解等，不涉及双方关系和承诺的内容）
...
- 新信息必须与已知信息逐条比对
- 相同、相似或语义重复的信息必须忽略（例如已知"阿狸去妈妈家吃团年饭"，就不要再提取"阿狸春节去了妈妈家"）
- 已知信息的补充或更新可以提取（例如已知"阿狸养了一只猫"，新信息"猫最近生病了"可以提取）
